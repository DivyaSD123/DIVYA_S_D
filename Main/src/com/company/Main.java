...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\DIVYA DHARWADKAR\\IdeaProjects\\input.txt"));
        ...
        for(int i=index-2;i<index+numberOfEmployees-2;i++) {
